...
const getScrip = () => {
  ...
  if (collection === 'ot') {
    ...
    if (book === 'genesis') {
      ...
      if (chapter === 1) {
        ...
        verse = getRandomVerse(45);
      } else if (chapter === 15) {
        verse = getRandomVerse(41);
      } else if (chapter === 16) {
        verse = getRandomVerse(50);
      } else if (chapter === 17) {
  ...
  // todo: put this up in their conditions
  if (book === 'samuel1') {
    book = '1 samuel'
  } else if (book === 'samuel2') {
    book = '2 samuel'
    ...
    book = '4 nephi'
  } else if (book === 'doctrineAndCovenants') {
    book = 'd & c'
  } else if (book === 'josephSmithMatthew') {
  ...
  if (book != undefined && chapter != undefined && verse != undefined) {
    ...
    return 'an important value returned undefined. check the code.';
  }
}

export default getScrip;
